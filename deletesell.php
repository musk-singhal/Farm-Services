<?php
   ...
   $query = "delete from cropinfo where sellname='$sell_name' and cropspecies='$crop_species'" ;
 ...
 //echo $res;
   ...
   if($res){
            ...
            echo "<h1>Successful delete Posted Crop</h1><br>";
            ...
            echo "<h1>Unsuccessful  delete Posted Crop</h1>";
